            ...
            @foreach($projectkey as $value)
                ...
                <div class="item m-1 card">
                    <div class="text-center">
                        ...
                        <h6 class="service-card-subTitle p-0 m-0">{{$value->project_desc}}</h6>
                        <a href="{{$value->project_link}}" class="normal-btn-outline mt-2 mb-4 btn">বিস্তারিত</a>
                    </div>
                </div>
